/*
 * @author            : Blake Pell
 * @website           : http://www.github.com/blakepell/ArgusFramework
 * @attribution       : https://github.com/blakepell/ArgusFramework/blob/master/src/Argus.Core/Collections/CircularObservableCollection%60T.cs
 * @copyright         : Copyright (c) 2003-2026, All rights reserved.
 * @license           : MIT
 */
...
namespace NEdit.Collections
{
    ...
    public sealed class CircularObservableCollection<T> : ICollection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        /// <summary>
